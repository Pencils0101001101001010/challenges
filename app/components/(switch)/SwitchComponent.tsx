...
const SwitchComponent = () => {
  ...
  const leafs = "/fullTrees.png";

  const leafsOf = "/deadTrees.png";

  return (
    <div style={{ background: isOn }} className="pageContainer ">
      <div
      ...
      <button onClick={changeColour} className="buttonOnOff">
        {isOn === offGradient ? (
          ...
          <svg
            ...
            width="80"
            fill="currentColor"
            className="bi bi-brightness-high-fill sunColor"
            viewBox="0 0 16 16"
          >
...
// if you want to change the background image when the baground colors changes
//   backgroundImage: `url(${isOn === onGradient ? leafs : leafsOf})`,
