    ...
    <div className="weatherContainer">
      <div className="wgrid">
        <div className="mainDisplay">
          <h1>May 23 </h1>
          <p>Saturday 14:06PM</p>
          <p>{sunDown} Sunset 19:36 </p>
        ...
        <div className="rghtSideGrid">
          <span className="iconsStl text-center"> 15:00{heavyRain} Rain </span>
          <span className="iconsStl text-center"> 16:00{heavyRain} Rain </span>
          <span className="iconsStl text-center"> 17:00{heavyRain} Rain </span>

          <span className="iconsStl text-center">
            18:00{overCastIcon}Cloudy
          </span>
          <span className="iconsStl text-center">
            19:00{overCastIcon}Cloudy
          </span>
          <span className="iconsStl text-center">20:00{cloudyMood}Cloudy</span>
          <span className="iconsStl text-center">21:00{cloudyMood}Cloudy</span>
          <span className="iconsStl text-center">22:00{cloudyMood}Cloudy</span>
          <span className="iconsStl text-center">23:00{cloudyMood}Cloudy</span>
          <span className="iconsStl text-center">00:00{cloudyMood}Cloudy</span>
          <span className="iconsStl text-center">01:00{cloudyMood}Cloudy</span>
          <span className="iconsStl text-center">02:00{cloudyMood}Cloudy</span>
          <span className="iconsStl text-center">03:00{cloudyMood}Cloudy</span>

          <span className="iconsStl text-center">
            04:00{rainAndThunder}Thunder
          </span>
          <span className="iconsStl text-center">
            05:00{rainAndThunder}Thunder
          </span>

          <span className="iconsStl text-center"> 06:00{heavyRain} Rain </span>
          <span className="iconsStl text-center">
            {" "}
            07:00{overCastIcon} Rain{" "}
          </span>
        </div>
      </div>
    </div>
