  ...
  return (
    <nav className="navbar navbar-expand-lg  nav-bg">
      <div className="container-fluid">
        ...
        >
          <span className="navbar-toggler-icon text-center text-white">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="30"
              fill="currentColor"
              className="bi bi-list text-white pt-0"
              viewBox="0 0 16 16"
            >
              <path
                fillRule="evenodd"
            ...
            <ul className="navbar-nav me-auto mb-2 mb-lg-0 ">
              <li className="nav-item dropdown ">
                ...
                <ul className="dropdown-menu dropdown-bg dropdownOverFlow">
                  ...
                  <li>
                    <Link className="dropdown-item text-white" href="/chart">
                      Charts 018
                    </Link>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link className="dropdown-item text-white" href="invoice">
                      Invoice 046
                    </Link>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link className="dropdown-item text-white" href="itinerary">
                      Itinerary 079
                    </Link>
                  </li>
                </ul>
